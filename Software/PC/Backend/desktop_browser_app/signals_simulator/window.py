...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionExport_Config = QAction(MainWindow)
        self.actionExport_Config.setObjectName(u"actionExport_Config")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Signal Simulator", None))
...
#if QT_CONFIG(shortcut)
        self.actionSave_values.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionExport_Config.setText(QCoreApplication.translate("MainWindow", u"Export Config", None))
#if QT_CONFIG(shortcut)
        self.actionExport_Config.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+E", None))
#endif // QT_CONFIG(shortcut)
