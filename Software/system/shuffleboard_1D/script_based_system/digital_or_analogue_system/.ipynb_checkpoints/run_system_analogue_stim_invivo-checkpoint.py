...
def start_scripts(real, duration_minutes):
    ...
    scripts = [
        ...
        "invivo/analogue_stim/Neuromimetic_E_game_to_features.py",
        "invivo/analogue_stim/Neuromimetic_F_signals_generator.py",
        "invivo/analogue_stim/Neuromimetic_F1_Signals_Visualiser.py",
        "invivo/analogue_stim/Neuromimetic_G_send_signals_to_usb_hub.py",
        "invivo/I_rewards_and_mappings.py"
    ]
