...
params.serial_port = '/dev/ttyACM0'  # Correct device node
...
class EEGVisualizer(QWidget):
    ...
    def init_ui(self):
        ...
        self.data_window.setWindowTitle('NUMERICAL SIGNAL DATA')
...
if __name__ == '__main__':
    ...
    visualizer = EEGVisualizer(num_channels=32, mqtt_client=mqtt_client)
